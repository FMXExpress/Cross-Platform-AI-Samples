...
class DeepSeekR1App(Form):
    ...
    def __init__(self, owner):
        ...
        self.SetProps(Caption="DeepSeek-R1 - Reasoning AI + Replicate", OnShow=self.__form_show, OnClose=self.__form_close)
        ...
        self.chat_label.SetProps(Parent=self.layout_chat, Align="Top", Text="Enter your complex logic or math problem (DeepSeek-R1 will reason through it):", Height=25)

        self.prompt_memo = Memo(self)
        self.prompt_memo.SetProps(Parent=self.layout_chat, Align="Client", Text="Solve this logic puzzle: If a farmer has 3 sheep and 2 goats, and he buys 5 more animals but loses 2, how many animals does he have now? Explain your reasoning.", Margins=Bounds(RectF(0, 5, 0, 5)))

        self.send_button = Button(self)
        self.send_button.SetProps(Parent=self.layout_main, Align="Top", Text="Ask DeepSeek-R1", Height=40, OnClick=self.__run_deepseek)

        # Output Section (Chain of Thought + Final Answer)
        ...
        self.output_label.SetProps(Parent=self.layout_output, Align="Top", Text="Reasoning & Response:", Height=25)
    ...
    def __run_deepseek(self, sender):
        ...
        self.status_bar.Text = "Status: Initializing DeepSeek-R1..."
    ...
    def __on_timer_tick(self, sender):
        ...
        try:
            ...
            if status == "succeeded":
                ...
                # DeepSeek-R1 on Replicate typically returns a list of tokens/strings
...
def main():
    ...
    Application.Title = "DeepSeek-R1 Reasoning Demo"
    Application.MainForm = DeepSeekR1App(Application)
