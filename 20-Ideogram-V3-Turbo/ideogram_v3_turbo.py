...
class IdeogramV3TurboApp(Form):
    ...
    def __init__(self, owner):
        ...
        self.SetProps(
            Caption="Ideogram v3 Turbo - Replicate Explore Next Pick",
        ...
        self.prompt_memo.SetProps(
            ...
            Text="A clean product hero image of a futuristic smartwatch on a reflective surface, dramatic studio lighting, crisp details",
        )
    ...
    def __on_timer_tick(self, sender):
        ...
        try:
            ...
            if status == "starting":
                ...
                file_name = f"./output_ideogram_v3_{file_hash}.png"
...
def main():
    ...
    Application.Title = "Ideogram v3 Turbo - Replicate"
    Application.MainForm = IdeogramV3TurboApp(Application)
